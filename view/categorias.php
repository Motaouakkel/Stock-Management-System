			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmCategorias">
						...
						<p></p>
						<span class="btn btn-primary" id="btnAdicionarCategoria">Ajouter <i class="fa fa-plus"></i></span>
					</form>
				</div>
				<div class="col-sm-6">
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Actualiser Catégorie</h4>
					</div>
					...
					<div class="modal-footer">
						<button type="button" id="btnAtualizaCategoria" class="btn btn-warning" data-dismiss="modal">Valider</button>
			...
			$('#btnAtualizaCategoria').click(function(){
				...
				$.ajax({
					...
					success:function(r){
						if(r==1){
							$('#tabelaCategoriaLoad').load("categorias/tabelaCategorias.php");
							alertify.success("Actalisation Effectuer:)");
						}else{
